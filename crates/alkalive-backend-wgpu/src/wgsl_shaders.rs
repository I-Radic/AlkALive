...
//! buffer per pipeline (`DYNAMIC_UNIFORM_STRIDE`, 256-byte aligned), so a
...
//! Rust mirrors ([`crate::wgpu_renderer::TextUniformsData`] /
//! [`crate::wgpu_renderer::RectUniformsData`)] must produce byte-identical
